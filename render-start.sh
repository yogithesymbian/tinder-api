...
# APP_KEY is automatically generated by Render (see render.yaml)
# Do not run key:generate as it prompts for confirmation in production
...
echo "========================================="
# Use php artisan serve instead of php -S for proper Laravel routing and initialization
